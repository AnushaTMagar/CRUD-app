    ...
    if(getData.length > 0){
        for(var i=tab_start; i<tab_end; i++){
            ...
            if(user){
                ...
                <td>${i+1}</td>
                <td><img src="${user.picture}" alt="" width="40" height="40"></td>
                <td>${user.fName + " " + user.lName}</td>
                <td>${user.addressVal}</td>
                <td>${user.contactVal}</td>
                <td>${user.emailVal}</td>
                
                <td>
                    <button onclick="readInfo('${user.picture}', '${user.fName}', '${user.lName}', '${user.addressVal}', '${user.contactVal}, '${user.emailVal}'')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${user.picture}', '${user.fName}', '${user.lName}', '${user.addressVal}', '${user.contactVal}, '${user.emailVal}'')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(pic, fname, lname, Address, Contact, Email, ){
    imgInput.src = pic
    fName.value = fname
    lName.value = lname
...
function editInfo(id, pic, fname, lname, Address,Contact, Email){
    isEdit = true
    editId = id
